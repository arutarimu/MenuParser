...
# Sometimes greyscaling and denoising help with better text recognition from Tesseract. But, sometimes raw is better.
...
# Loading the image passed through the argument to OpenCV
image = cv.imread(args.image)

# This block of code handles the first text recognition from Tesseract and store it into a txt file.
